							...
							<div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/faq/classNameic.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="/user_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="/customer_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="vendor_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									<span className="menu-link">
										...
										<span className="menu-title">Databases</span>
										<span className="menu-arrow"></span>
									</span>
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										<div className="menu-item">
											<a className="menu-link" href="/unit_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="/country_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="/nature_of_business_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
												<span className="menu-title">Nature of Business</span>
											</a>
										</div>
										<div className="menu-item">
											<a className="menu-link" href="/brand_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="/industry_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="/category_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
												<span className="menu-title">Main Category</span>
											</a>
										</div>
										<div className="menu-item">
											<a className="menu-link" href="/subcategory_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="/child_category_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
												<span className="menu-title">Child Category</span>
											</a>
										</div>
										<div className="menu-item">
											<a className="menu-link" href="/product_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div className="menu-item">
											<a className="menu-link" href="/baazaar_coupons_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
												<span className="menu-title">Baazaar Coupons</span>
											</a>
										</div>
										<div className="menu-item">
											<a className="menu-link" href="/company_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
												<span className="menu-title">Company Coupons</span>
											</a>
										</div>
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										<div className="menu-item">
											<a className="menu-link" href="/brands_hub_list">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
												<span className="menu-title">Brands</span>
								...
								<div className="menu-item">
									<a className="menu-link" href="../../demo1/dist/documentation/getting-started/changelog.html">
										...
										<span className="menu-title">Changelog v8.0.37</span>
									</a>
								</div> */}
