...
const load_Data= async()=>{
    ...
    axios.post('http://localhost:8000/brand/brand_on_id',{Id:Id},{
      headers: {
...
const onSubmit =  e => {
    ...
    if(use_data.brand_name.trim()===""){
     ...
     axios.post('http://localhost:8000/brand/update_brand',{Id:Id,brand_name:use_data.brand_name,status:use_data.status},{
        headers: {
            "Authorization":"Bearer "+ Cookies.get('token') 
        }                
    } )
   ...
   <div className="toolbar" id="kt_toolbar">					
		<div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">	
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" classNameName="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">						
				<h1 className="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Edit Brand						
